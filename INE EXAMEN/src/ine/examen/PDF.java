...
public class PDF {
    ...
    public void ine(String photopath, String nombre, String apellidoP, String apellidoM, String calle, String casa, String colonia, String cp, String municipio, String estado, String curp) {
        //crea documento
        Document document = new Document();
        try {
            //crea escritor
            PdfWriter writer = PdfWriter.getInstance(document,
                    new FileOutputStream("inexd.pdf"));
            document.open();
